    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Integração Câmara Arapongas</h5>
            <form class="form-signin" action="ArapongasServlet" method="post">
              <div class="form-label-group">
                <input type="entidade" id="inputLogin" name="entidade" class="form-control" value="8787" required autofocus>
                <label for="inputLogin">Entidade Arapongas</label>
              </div>
              <p>
              <p>
              <div class="form-label-group">
